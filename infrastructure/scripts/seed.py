    ...
    with engine.begin() as conn:
        ...
        for lid, subj, title, age, diff in lesson_ids:
            ...
            if subj == "letters":
                qlist = [
                    mcq(
                        f"Chữ nào đứng đầu trong '{title}'?",
                        ["A", "B", "C", "D"],
                        0,
                        "Chữ A luôn đứng đầu",
                    ),
                    tf(
                        "Chữ 'B' là chữ cái đầu tiên trong bảng chữ cái",
                        False,
                        "Chữ A là chữ cái đầu tiên",
                    ),
                    mcq(
                        "Từ 'MÈO' có bao nhiêu chữ cái?",
                        ["2", "3", "4", "5"],
                        1,
                        "M-È-O = 3 chữ",
                    ),
                    mcq(
                        "Âm đầu của từ 'NHÀ' là gì?",
                        ["N", "NH", "A", "H"],
                        1,
                        "NH là phụ âm ghép",
                    ),
                    tf(
                        "Chữ 'Z' có trong bảng chữ cái tiếng Việt",
                        False,
                        "Tiếng Việt không có chữ Z",
                    ),
                    mcq(
                        "Chữ nào là nguyên âm?",
                        ["B", "A", "M", "T"],
                        1,
                        "A là nguyên âm",
                    ),
                    ...
                    tf(
                        "Từ 'BÉO' có 2 vần",
                        False,
                        "BÉ-O là 2 vần đúng, hoặc BÉO = 1 vần tùy cách ghép",
                    ),
                ...
                qlist += [
                    ...
                    mcq(
                        "Giờ nào đúng 12 giờ trưa?",
                        ["12:00", "11:00", "1:00", "6:00"],
                        0,
                        "12:00 là trưa",
                    ),
                    fib("10 - 4 = ?", "6", "10 - 4 = 6"),
                ...
                qlist = [
                    mcq(
                        "Loại nào khác với nhóm còn lại?",
                        ["MÈO", "CHÓ", "CÁ", "XE"],
                        2,
                        "CÁ bơi dưới nước, còn lại trên cạn",
                    ),
                    ...
                    mcq(
                        "Cái nào không thuộc nhóm?",
                        ["NHÀ", "TRƯỜNG", "BỆNH VIỆN", "CON MÈO"],
                        3,
                        "CON MÈO là động vật",
                    ),
                    mcq(
                        "Số lớn nhất trong 3, 7, 1, 9 là?",
                        ["3", "7", "1", "9"],
                        3,
                        "9 lớn nhất",
                    ),
                ...
                qlist = [
                    mcq(
                        ...
                        ["Trái Đất", "Sao Thủy", "Sao Hỏa", "Sao Kim"],
                        1,
                        "Sao Thủy",
                    ),
                    ...
                    mcq(
                        ...
                        ["Sao Sirius", "Mặt Trời", "Sao Bắc Cực", "Sao Hỏa"],
                        1,
                        "Mặt Trời",
                    ),
                    mcq(
                        "Rễ cây làm gì?",
                        ["Hấp thụ nước", "Quang hợp", "Thở", "Bay"],
                        0,
                        "Rễ hấp thụ nước và chất dinh dưỡng",
                    ),
                    mcq(
                ...
                qlist = [
                    mcq(
                        ...
                        ["Tôi đi học", "Đi học tôi", "Học tôi đi", "Tôi học đi"],
                        0,
                        "Tôi đi học",
                    ),
                    tf("Một đoạn văn có 3-5 câu", True, "Đúng"),
                    mcq(
                        "Robot cần gì để di chuyển?",
                        ["Lệnh", "Pin", "Cả hai", "Không cần gì"],
                        2,
                        "Cả lệnh và pin",
                    ),
                    mcq(
                        "Trong lập trình, 'vòng lặp' là gì?",
                        ["Lặp lại", "Dừng lại", "Xóa", "Tạo mới"],
                        0,
                        "Lặp lại lệnh",
                    ),
                    mcq(
                        "Câu nào kể chuyện hay hơn?",
                        ["Con mèo chạy", "Con mèo lông vàng chạy nhanh trên sân"],
                        1,
                        "Chi tiết hơn = hay hơn",
                    ),
                ]
        ...
        for ctype in ["lessons", "questions", "games"]:
            conn.execute(
                ...
                {
                    "ct": ctype,
                    "chk": hashlib.sha256(ctype.encode()).hexdigest(),
                    "now": datetime.utcnow(),
                },
            )
