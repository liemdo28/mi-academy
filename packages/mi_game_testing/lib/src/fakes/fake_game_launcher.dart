...
class FakeGameLauncher {
  ...
  Future<MiGameResult> _successResult(MiGameLaunchRequest r) async {
    ...
    return MiGameResult(
      ...
      durationSeconds: 120,
      completed: true,
      masteryEvidence: 0.82,
      skillEvidence: {
        'math': ['addition', 'number_recognition'],
        'language': [r.language]
      },
  ...
  Future<MiGameResult> _pausedResult(MiGameLaunchRequest r) async {
    ...
    return MiGameResult(
      ...
      metadata: {
        'session_type': 'paused',
        'accuracy': 0.83,
        'exit_reason': 'paused_and_abandoned'
      },
    );
  }
  ...
  Future<MiGameResult> _highMasteryResult(MiGameLaunchRequest r) async {
    ...
    return MiGameResult(
      ...
      masteryEvidence: 1.0,
      skillEvidence: {
        'math': ['addition', 'subtraction', 'number_order'],
        'language': [r.language]
      },
      metadata: {
        'session_type': 'high_mastery',
        'perfect_run': true,
        'bonus_stars': 3
      },
    );
