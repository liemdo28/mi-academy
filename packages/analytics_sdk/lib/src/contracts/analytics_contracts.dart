...
class AnalyticsContracts {
  static const _contracts = <AnalyticsContractMeta>[
    AnalyticsContractMeta(
      ...
      requiredFields: ['eventId', 'eventType', 'childProfileId', 'sessionId', 'timestamp'],
      forbiddenFields: ['password', 'token', 'secret', 'ssn', 'credit_card', 'email', 'phone'],
    ),
    AnalyticsContractMeta(
    ...
    AnalyticsContractMeta(
      ...
      requiredFields: ['reportId', 'childProfileId', 'periodStart', 'periodEnd', 'periodType'],
      forbiddenFields: ['password', 'token', 'secret', 'email'],
    ),
    AnalyticsContractMeta(
    ...
    AnalyticsContractMeta(
      ...
      requiredFields: ['skillId', 'skillName', 'accuracy', 'masteryLevel', 'attemptsTotal', 'attemptsCorrect'],
      forbiddenFields: ['password', 'token', 'secret', 'email'],
    ),
  ];
