...
class AdaptiveContracts {
  static const _contracts = <AdaptiveContractMeta>[
    AdaptiveContractMeta(
      ...
      requiredFields: ['adjustmentId', 'childProfileId', 'gameId', 'levelId',
        'currentDifficulty', 'recommendedDifficulty', 'confidence', 'direction'],
    ...
    AdaptiveContractMeta(
      ...
      requiredFields: ['itemId', 'childProfileId', 'skillId', 'contentId',
        'easeFactor', 'interval', 'repetitions', 'nextReviewAt', 'status'],
    ...
    AdaptiveContractMeta(
      ...
      requiredFields: ['pathId', 'childProfileId', 'ageGroup', 'subject', 'status'],
      forbiddenFields: ['password', 'token', 'secret', 'email'],
    ),
    AdaptiveContractMeta(
      ...
      requiredFields: ['nodeId', 'nodeType', 'contentId', 'title', 'orderIndex', 'status'],
      forbiddenFields: ['password', 'token', 'secret', 'email'],
    ),
    AdaptiveContractMeta(
      ...
      forbiddenFields: ['password', 'token', 'secret', 'email', 'child_name', 'location'],
    ),
  ];
