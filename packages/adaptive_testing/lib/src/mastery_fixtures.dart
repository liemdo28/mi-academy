...
class MasteryFixtures {
  ...
  static AttemptEvidence correctAttempt1({int difficulty = 1}) =>
      AttemptEvidence(
  ...
  static AttemptEvidence correctWithHints({int difficulty = 2}) =>
      AttemptEvidence(
        attemptedAt: DateTime.now(),
        correct: true,
        hintsUsed: 2,
  ...
  static AttemptEvidence incorrectAttempt({int difficulty = 2}) =>
      AttemptEvidence(
        attemptedAt: DateTime.now(),
        correct: false,
        hintsUsed: 1,
