...
from apps.api import models  # noqa: E402,F401  — import registers all models on Base.metadata
...
def _sync_database_url() -> str:
    """Alembic runs synchronously — convert the app's async DB URL to its sync equivalent."""
    return settings.DATABASE_URL.replace("+asyncpg", "").replace("+aiosqlite", "")
