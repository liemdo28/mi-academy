...
def main():
    ...
    for game_id, file_name, solver, label in [
        ...
        ("color_builder", "color_builder.json", solve_placement, "Color Builder"),
        ("animal_homes", "animal_homes.json", solve_matching, "Animal Homes"),
        ("daily_routine", "daily_routine.json", solve_sequence, "Daily Routine"),
        ("healthy_foods", "healthy_foods.json", solve_multi_select, "Healthy Foods"),
        ("letter_hunt", "letter_hunt.json", solve_placement, "Letter Hunt"),
        ("number_train", "number_train.json", solve_sequence, "Number Train"),
        ("emotion_match", "emotion_match.json", solve_matching, "Emotion Match"),
        ("puzzle_parts", "puzzle_parts.json", solve_placement, "Puzzle Parts"),
        ("odd_one_out", "odd_one_out.json", solve_multi_select, "Odd One Out"),
        ("opposites", "opposites.json", solve_matching, "Opposites"),
        ("weather_today", "weather_today.json", solve_matching, "Weather Today"),
        ("memory_journey", "memory_journey.json", solve_sequence, "Memory Journey"),
        (
            "category_expert",
