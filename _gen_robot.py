...
levels = [
    ...
    },
    {
        ...
        "objective_vi": "Rẽ trái — quay hướng",
        "prompt_vi": "Đi tới, rẽ trái, đi tới!",
        "prompt_en": "Forward, turn left, forward!",
        "grid": {"width": 3, "height": 3}, "start": {"x": 0, "y": 0, "facing": "east"}, "goal": {"x": 1, "y": 1},
        "available": ["MOVE_FORWARD", "TURN_LEFT"],
        "required_vi": ["START", "MOVE_FORWARD", "TURN_LEFT", "MOVE_FORWARD"],
        "required_en": ["START", "MOVE_FORWARD", "TURN_LEFT", "MOVE_FORWARD"],
        "hints_vi": ["Dùng lệnh Quay trái trước, rồi Tiến"],
        "hints_en": ["Use Turn Left first, then Forward"],
        "skillIds": ["logic.programming_sequences"],
    },
    {
    ...
    },
    {
        ...
        "prompt_vi": "Tìm đường ngắn nhất tới cờ! (tối đa 6 lệnh)",
        "prompt_en": "Find the shortest path to the flag! (max 6 commands)",
        "grid": {"width": 4, "height": 3}, "start": {"x": 0, "y": 0, "facing": "east"}, "goal": {"x": 3, "y": 2},
        "available": ["MOVE_FORWARD", "TURN_LEFT", "TURN_RIGHT"],
        "required_vi": ["START", "MOVE_FORWARD", "MOVE_FORWARD", "MOVE_FORWARD", "TURN_RIGHT", "MOVE_FORWARD", "MOVE_FORWARD", "TURN_RIGHT", "MOVE_FORWARD"],
        "required_en": ["START", "MOVE_FORWARD", "MOVE_FORWARD", "MOVE_FORWARD", "TURN_RIGHT", "MOVE_FORWARD", "MOVE_FORWARD", "TURN_RIGHT", "MOVE_FORWARD"],
    ...
    },
    {
        ...
        "objective_vi": "Chướng ngại + thu thập — thuật toán hoàn chỉnh",
        "prompt_vi": "Thu thập tất cả items, tránh chướng ngại, về đích!",
        "prompt_en": "Collect all items, avoid obstacles, reach the goal!",
        "grid": {"width": 4, "height": 4}, "start": {"x": 0, "y": 0, "facing": "east"}, "goal": {"x": 3, "y": 3},
        "obstacles": [{"x": 1, "y": 0}],
        "collectibles": [{"x": 0, "y": 1}, {"x": 2, "y": 2}],
        "available": ["MOVE_FORWARD", "TURN_LEFT", "TURN_RIGHT", "COLLECT", "IF_PATH_AHEAD"],
        "required_vi": ["START", "COLLECT", "TURN_LEFT", "MOVE_FORWARD", "COLLECT", "TURN_RIGHT", "MOVE_FORWARD", "MOVE_FORWARD", "TURN_RIGHT", "MOVE_FORWARD", "MOVE_FORWARD", "COLLECT", "TURN_LEFT", "MOVE_FORWARD", "MOVE_FORWARD"],
        "required_en": ["START", "COLLECT", "TURN_LEFT", "MOVE_FORWARD", "COLLECT", "TURN_RIGHT", "MOVE_FORWARD", "MOVE_FORWARD", "TURN_RIGHT", "MOVE_FORWARD", "MOVE_FORWARD", "COLLECT", "TURN_LEFT", "MOVE_FORWARD", "MOVE_FORWARD"],
