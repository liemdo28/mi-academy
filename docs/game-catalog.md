...
| 09 | Đọc hiểu truyện ngắn | 8–12 | **Built — Deep UI** | `story_comprehension`; reading-lab surface with localized passage/step data, 30 bilingual levels, 5 difficulty tiers |
...
| 30 | Sáng tạo tự do | 5–12 | **Built — Creative composition** | `free_creativity`; participation-based story lab with scene, character, feeling, and story-idea composition, no right/wrong creativity scoring, save/restore, 30 bilingual levels, 5 difficulty tiers |
