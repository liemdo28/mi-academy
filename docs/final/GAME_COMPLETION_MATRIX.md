...
- Free Creativity now uses a dedicated participation-based story lab (`creative_story_lab`) with scene, character, feeling, and story-idea composition; it does not grade creativity as right/wrong, saves in-progress composition through snapshots, and persists completed creative artifacts in a local-first artifact store.
